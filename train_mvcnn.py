...
if __name__ == '__main__':
    ...
    trainer = ModelNetTrainer(cnet, train_loader, val_loader, optimizer_model,optimizer_centerloss,center_loss, 'svcnn', log_dir, num_views=1)
    trainer.train(20)
    ...
    print('num_train_files: '+str(len(train_dataset.filepaths)))
    print('num_val_files: '+str(len(val_dataset.filepaths)))
    trainer = ModelNetTrainer(cnet_2, train_loader, val_loader, optimizer_model,optimizer_centerloss,center_loss, 'mvcnn', log_dir, num_views=args.num_views)#loss_2,
    trainer.train(20)
